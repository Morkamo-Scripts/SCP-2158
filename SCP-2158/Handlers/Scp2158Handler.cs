...
public class Scp2158Handler : Scp2158Component
{
    ...
    protected override void OnShot(ShotEventArgs ev)
    {
        ...
        if (CheckCapsuleHit(from + ev.Player.CameraTransform.forward, to, radius, out var hitbox))
        {
            ...
            BulletTrace(from + ev.Player.CameraTransform.forward * 1.2f, hitbox.transform.position, 0.055f, 0.6f, Color.cyan, 15f);
        ...
        if (isDryShot)
            BulletTrace(from + ev.Player.CameraTransform.forward * 1.2f, to, 0.055f, 0.6f, Color.white, 15f);
